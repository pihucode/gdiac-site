# -*- encoding: utf-8 -*-
# stub: jekyll-asciidoc 2.0.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2016-07-06"
  s.description = "A Jekyll plugin that converts AsciiDoc source files in your site to HTML pages using Asciidoctor.".freeze
  s.email = ["dan.j.allen@gmail.com".freeze]
  s.homepage = "https://github.com/asciidoctor/jekyll-asciidoc".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "3.1.2".freeze
  s.summary = "A Jekyll plugin that converts AsciiDoc source files in your site to HTML pages using Asciidoctor.".freeze
